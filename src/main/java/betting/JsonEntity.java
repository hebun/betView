...
public class JsonEntity extends StringEntity {
	 ...
	 */
	public JsonEntity(final List<? extends NameValuePair> parameters,
			final String charset) throws UnsupportedEncodingException {

		super(listToJson(parameters), ContentType.create(
	...
	public JsonEntity(final Iterable<? extends NameValuePair> parameters,
		...
		super(URLEncodedUtils.format(parameters, charset != null ? charset
				: HTTP.DEF_CONTENT_CHARSET), ContentType.create(
				URLEncodedUtils.CONTENT_TYPE, charset));
	}
